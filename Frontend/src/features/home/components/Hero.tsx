  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center pt-8 md:pt-20">
      ...
      <div className="hidden mb-12 animate-in fade-in slide-in-from-top-4 duration-1000 md:block">
        <Button
          variant="outline"
          className="rounded-full bg-foreground/5 border-foreground/10 backdrop-blur-sm hover:bg-foreground/10 transition-all px-4 py-2 h-auto"
          asChild
        >
          <a href="https://calendly.com" target="_blank" rel="noopener noreferrer">
            <FiCalendar className="size-3.5 text-sky-500" />
      ...
      <Link
        to="/about"
        className="group flex items-center gap-3 px-4 py-2 transition-all border rounded-full bg-foreground/5 dark:bg-black/40 border-foreground/10 hover:border-foreground/20 hover:bg-foreground/10 dark:hover:bg-black/60 backdrop-blur-md animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500"
      >
        <div className="flex items-center justify-center w-8 h-8 overflow-hidden bg-gradient-to-br from-foreground/20 to-foreground/5 dark:from-white/20 dark:to-white/5 rounded-full border border-foreground/10">
          <img
