...
export const ONCE_UI: Project = {
  ...
  avatars: [
    "https://github.com/Rhey-Ranido.png",
...
export const FLOW_TASK: Project = {
  ...
  images: [
    "https://images.unsplash.com/photo-1454165833762-02ac4f40c1ce?q=80&w=2070&auto=format&fit=crop",
  ],
  link: "/projects/flow-task",
  avatars: ["https://github.com/Rhey-Ranido.png"],
};

// legacy export for safety
export const PROJECTS = [ONCE_UI, NEXUS_DASH, SHOP_SPARK, FLOW_TASK];
